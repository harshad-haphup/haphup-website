    ...
    <>
      ...
      <header className="w-full h-screen flex items-center relative bg-white-color dark:bg-dark-white-color">
        <motion.div
          ...
          transition={{ delay: 0.5, duration: 0.4, type: "keyframes" }}
          className="absolute w-7 h-64 bg-primary-color/70 right-28 top-0 rounded-full rotate-45 origin-top"
        ></motion.div>
        <motion.div
          initial={{ y: -100, opacity: 0, rotate: 20 }}
          animate={{ y: 0, opacity: 1, rotate: 45 }}
          transition={{ delay: 0.5, duration: 0.4, type: "keyframes" }}
          className="absolute w-7 h-56 bg-accent-color/70  right-12 top-0 rounded-full rotate-45 origin-top"
        ></motion.div>
        ...
        <div className="flex items-center justify-center w-full h-screen flex-col-reverse md:flex-row bg-bg-color dark:bg-dark-bg-color">
          ...
          >
            <Image
              ...
              alt="hero-img"
              placeholder="blur"
              blurDataURL={"../public/assests/Saly-10.svg"}
