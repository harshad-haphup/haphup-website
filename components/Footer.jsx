...
const Footer = () => {
  return (
    <>
    <div className='p-4 sm:p-16 mt-10 flex flex-col sm:flex-row justify-between items-center sm:items-center  bg-secondary-color/5'>
        <div className='sm:px-4 flex flex-col items-center sm:items-start'>
            ...
            <div className='flex items-center gap-2 sm:gap-4 mt-6'>
                ...
                <p className='text-text-color text-xs sm:text-base text-justify whitespace-normal sm:text-start'>304, Amar Business Park, Sadanand Estates, Veerbhadra Nagar, <br /> Baner, Pune, Maharashtra 411045</p>
            </div>
        ...
        <div className='mt-6 sm:mt-0'>
            <div className='flex items-center'>
                ...
                <p className='text-heading-color font-semibold text-sm sm:text-xl pl-2 sm:pl-4 cursor-pointer'>hello@haphup.com</p>
            </div>
        </div>
    </div>
